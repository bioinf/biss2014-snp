...
# of the fs.
folded = dadi.Spectrum.from_data_dict(dd, ['WG','EG'], [12,6],
                                      polarized=False)
...
# fs_corr = dadi.Spectrum.from_data_dict_corrected(dd, ['WG','EG'], [12,6],
#                                                  'fux_table.dat')
